...
• /tview — запуск бота
• Введите комнаду: /tview тикер MOEX (например, /tview GOLD-6.26)
• Пока придется учитывать регистр и вводить заглавные буквы
• Обязательно перед тикером прописать /tview
...
• /tview GOLD-6.26 → найдет код наиболее подходящего спреда для TView
"""
